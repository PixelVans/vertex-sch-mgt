...
const daysUntilMonday = (1 - currentDay + 7) % 7; // Calculate how many days until the upcoming Monday
const mondayDate = new Date(currentDate);
mondayDate.setDate(currentDate.getDate() + daysUntilMonday); // Set to the upcoming Monday

// Helper function to get a date for a specific day of the week (relative to Monday)
const getDateForDay = (monday: Date, dayOffset: number) => {
  const date = new Date(monday);
  date.setDate(monday.getDate() + dayOffset); // Add the offset to get the correct weekday
  return date;
};
...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 0).setHours(8, 0)),
    end: new Date(getDateForDay(mondayDate, 0).setHours(8, 45)),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 0).setHours(9, 0)),
    end: new Date(getDateForDay(mondayDate, 0).setHours(9, 45)),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 1).setHours(10, 0)), // Tuesday
    end: new Date(getDateForDay(mondayDate, 1).setHours(10, 45)),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 1).setHours(11, 0)), // Tuesday
    end: new Date(getDateForDay(mondayDate, 1).setHours(11, 45)),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 2).setHours(13, 0)), // Wednesday
    end: new Date(getDateForDay(mondayDate, 2).setHours(13, 45)),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 3).setHours(14, 0)), // Thursday
    end: new Date(getDateForDay(mondayDate, 3).setHours(14, 45)),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 4).setHours(9, 0)), // Friday
    end: new Date(getDateForDay(mondayDate, 4).setHours(9, 45)),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(getDateForDay(mondayDate, 4).setHours(10, 0)), // Friday
    end: new Date(getDateForDay(mondayDate, 4).setHours(10, 45)),
  },
];
